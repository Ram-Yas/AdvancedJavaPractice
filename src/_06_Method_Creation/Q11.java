...
public class Q11 {
    static int bakiye = 1000; //class level
    static Scanner scan = new Scanner(System.in); // her seferinde yazmamak icin buraya yazildi
    //herkesin gormesi icin yukari yazdik
